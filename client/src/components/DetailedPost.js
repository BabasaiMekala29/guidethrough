...
function DetailedPost() {
    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
            try {
                const response = await fetch(`https://guidethroughh.vercel.app/getpost/${id}`);
                if (!response.ok) {
    ...
    useEffect(() => {
        const fetchInteractionsData = async () => {
            try {
                const response = await fetch(`https://guidethroughh.vercel.app/post/${id}/interactions/${userInfo?.username}`);
                const data = await response.json();
    ...
    useEffect(() => {
        ...
        if (post) {
            const fetchCommentsData = async () => {
                try {
                    const response = await fetch(`https://guidethroughh.vercel.app/post/${id}/comment`);
                    if (!response.ok) {
    ...
    const handleUpvote = async () => {
        ...
        try {
            const response = await fetch(`https://guidethroughh.vercel.app/post/${id}/upvote`, {
                method: 'PUT',
    ...
    const handleDownvote = async () => {
        ...
        try {
            const response = await fetch(`https://guidethroughh.vercel.app/post/${id}/downvote`, {
                method: 'PUT',
                body: JSON.stringify({ user: userInfo?.username }),
                headers: {
                    'Content-Type': 'application/json',
    ...
    const handleLike = async () => {
        ...
        try {
            const response = await fetch(`https://guidethroughh.vercel.app/post/${id}/like`, {
                method: 'PUT',
                body: JSON.stringify({ user: userInfo?.username }),
                headers: {
                    'Content-Type': 'application/json',
    ...
    const handleSave = async () => {
        ...
        if (post) {
            try {
                const response = await fetch(`https://guidethroughh.vercel.app/post/${id}/save`, {
                    method: 'PUT',
    ...
    const addComment = async (comment) => {
        ...
        try {
            ...
            if (response.ok) {
                setCommentsData(data);
                await fetch(`https://guidethroughh.vercel.app/post/${id}/notify`, {
                    method: 'PUT',
    ...
    const handleShare = () => {
        const postLink = `https://guidethrough-frontend.vercel.app/post/${category}/${subcategory}/${section}/${id}`;
