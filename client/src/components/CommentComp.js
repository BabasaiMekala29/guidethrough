...
function CommentComp({ cmt, post }) {
  ...
  useEffect(() => {
    const fetchInteractionsData = async () => {
      try {
        ...
        const response = await fetch(`https://guidethroughh.vercel.app/post/${post._id}/comment/${cmt._id}/cominteractions/${userInfo?.username}`);
  ...
  const handleUpvote = async () => {
    ...
    try {
      const response = await fetch(`https://guidethroughh.vercel.app/post/${post._id}/comment/${cmt._id}/upvote`, {
        method: 'PUT',
  ...
  const handleDownvote = async () => {
    ...
    try {
      const response = await fetch(`https://guidethroughh.vercel.app/post/${post._id}/comment/${cmt._id}/downvote`, {
        method: 'PUT',
        body: JSON.stringify({ user: userInfo?.username }),
        headers: {
          'Content-Type': 'application/json',
