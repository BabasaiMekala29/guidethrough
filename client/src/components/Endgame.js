...
function Endgame({uid}) {
    ...
    //         method: 'POST',
    //         body:JSON.stringify({title,description,upvote,downvote,likes,category:head,subcategory:subhead,section:selectedItem}),
            ...
            <AppBar position="static" sx={{ backgroundColor: "#fefefe", color: '#000000' }}>
                <Container maxWidth="xl">
                    <Toolbar disableGutters>
                        ...
                        <Link style={{color:'#000000'}} to={'/category/:head/:subhead/postt'}>
